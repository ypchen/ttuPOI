#!/bin/sed -nf
#
# I am not the author of the following sed rules.
#
# I found them on the web by using Google and downloaded them
# long time ago without writing down the name of the author.
#
# I sincerely apologize for being unable to give appropriate
